...
def main(args):
    ...
    # LDA wraps sklearn.LinearDiscriminantAnalysis and has no torch parameters;
    # train_lda fits via sklearn directly, so skip optimizer/scheduler setup.
    if args.model_choice == "lda":
        optimizer = None
        scheduler = None
    else:
