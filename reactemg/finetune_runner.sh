...
for patient_id in "${patient_ids[@]}"; do
    ...
    command="python3 main.py --offset 30 --num_classes 3 --dataset_selection roam_only --window_size 600 --val_patient_ids ${patient_id} --exp_name ${exp_name} --epn_subset_percentage 1.0 --epochs 5 --model_choice any2any --inner_window_size 600 --saved_checkpoint_pth ${saved_checkpoint_pth}"
