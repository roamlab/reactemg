#!/bin/bash
# Evaluate every EPN-trained 6-class model produced by train_all_epn_6class.sh.
#
# Fill in the six checkpoint paths below (relative to reactemg/, e.g.
# "model_checkpoints/ann_epn_6class_<stamp>_<host>/epoch_12.pth"), then run:
#   source scripts/eval_all_epn_6class.sh   # from reactemg/
#   bash   scripts/eval_all_epn_6class.sh   # from anywhere
...
#                      FILL THESE IN
# ============================================================
CKPT_ANY2ANY="model_checkpoints/any2any_epn_6class_2026-05-26_13-12-22_pc1/epoch_11.pth"
CKPT_ANN="model_checkpoints/ann_epn_6class_2026-05-27_02-02-03_pc1/epoch_12.pth"
CKPT_LSTM="model_checkpoints/lstm_epn_6class_2026-05-27_03-34-35_pc1/epoch_12.pth"
CKPT_ED_TCN="model_checkpoints/ed_tcn_epn_6class_2026-05-27_04-05-06_pc1/epoch_12.pth"
CKPT_TRAHGR="TODO"
CKPT_LDA="TODO"
# ============================================================
...
echo ""
echo "All 6-class EPN evals complete."
